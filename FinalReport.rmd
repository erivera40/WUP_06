...
$H_0$: There is no attitude toward capitol punishment (cappun) independent of race (race).  
...
Cat_Cat helper file will be used as both variables are categorical.    
...
Among those who favor cappun are predominately white. Percentage wise there are more blacks that oppose cappun rather than are in favor of. Also noted are that other races mostly favor cappun than oppose.   
...
Among the white race it favors capitol punishment by 65%. While the black race oppose capitol punishment by 57% and 55% favor cappun in other races.   
...
There is a significant difference in attitude for capitol punishment based on race. In this larger data set there is a difference in attitude for capitol punishment in all three races. In the smaller data set there was a significant difference in attitude between whites and blacks, there is not enough data to determine if there is a significant differences between other races.   
